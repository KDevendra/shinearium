...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="<?php echo base_url(''); ?>include/web/libs/bootstrap/css/bootstrap.min.css"
      type="text/css"
    />
    <link
      rel="stylesheet"
      href="<?php echo base_url(''); ?>include/web/libs/feather-font/css/iconfont.css"
      type="text/css"
    />
    <link
      rel="stylesheet"
      href="<?php echo base_url(''); ?>include/web/libs/icomoon-font/css/icomoon.css"
      type="text/css"
    />
    <link
      rel="stylesheet"
      href="<?php echo base_url(''); ?>include/web/libs/font-awesome/css/font-awesome.css"
      type="text/css"
    />
    <link
      rel="stylesheet"
      href="<?php echo base_url(''); ?>include/web/libs/wpbingofont/css/wpbingofont.css"
      type="text/css"
    />
    <link
      rel="stylesheet"
      href="<?php echo base_url(''); ?>include/web/libs/elegant-icons/css/elegant.css"
      type="text/css"
    />
    <link
      rel="stylesheet"
      href="<?php echo base_url(''); ?>include/web/libs/slick/css/slick.css"
      type="text/css"
    />
    <link
      rel="stylesheet"
      href="<?php echo base_url(''); ?>include/web/libs/slick/css/slick-theme.css"
      type="text/css"
    />
    <link
      rel="stylesheet"
      href="<?php echo base_url(''); ?>include/web/libs/mmenu/css/mmenu.min.css"
      type="text/css"
    />
    <!-- Site Stylesheet -->
    <link
      rel="stylesheet"
      href="<?php echo base_url(''); ?>include/web/assets/css/app.css"
      type="text/css"
    />
    <link
      rel="stylesheet"
      href="<?php echo base_url(''); ?>include/web/assets/css/responsive.css"
      type="text/css"
    />
    <!-- Google Web Fonts -->
    <link
        ...
        <div id="main-content" class="main-content">
          <div id="primary" class="content-area">
            <div id="content" class="site-content" role="main">
                      ...
                      <div class="item-content">
                        <div class="content-image">
                          <img
                            width="1920"
                            height="1080"
                            src="<?php echo base_url('');?>include/web/media/slider/1-1.jpg"
                            alt="Image Slider"
                          />
                        </div>
                      ...
                      <div class="item-content">
                        <div class="content-image">
                          <img
                            width="1920"
                            height="1080"
                            src="<?php echo base_url('');?>include/web/media/slider/1-2.jpg"
                            alt="Image Slider"
                          />
                        </div>
                        <div class="item-info horizontal-start vertical-middle">
                      ...
                      <div class="item-content">
                        <div class="content-image">
                          <img
                            width="1920"
                            height="1080"
                            src="<?php echo base_url('');?>include/web/media/slider/1-3.jpg"
                            alt="Image Slider"
                          />
                        </div>
                        <div class="item-info horizontal-start vertical-middle">
                                ...
                                <div class="banner-image">
                                  <a href="/html/shop.html">
                                    <img
                                      width="630"
                                      height="457"
                                      src="<?php echo base_url('');?>include/web/media/banner/banner-1-1.jpg"
                                      alt="Banner Image"
                                    />
                                  </a>
                                </div>
                                ...
                                <div class="banner-image">
                                  <a href="/html/shop.html">
                                    <img
                                      width="450"
                                      height="457"
                                      src="<?php echo base_url('');?>include/web/media/banner/banner-1-2.jpg"
                                      alt="Banner Image"
                                    />
                                  </a>
                                </div>
                                ...
                                <div class="banner-image">
                                  <a href="/html/shop.html">
                                    <img
                                      width="630"
                                      height="457"
                                      src="<?php echo base_url('');?>include/web/media/banner/banner-1-3.jpg"
                                      alt="Banner Image"
                                    />
                                  </a>
                                </div>
                          ...
                          >
                            <div class="item item-product-cat slick-slide">
                              <div class="item-product-cat-content">
                                <a href="/html/shop.html">
                                  <div class="item-image animation-horizontal">
                                    <img
                                      width="258"
                                      height="258"
                                      src="<?php echo base_url('');?>include/web/media/product/cat-1.jpg"
                                      alt="Bracelets"
                                    />
                                  </div>
                                </a>
                                <div class="product-cat-content-info">
                                  <h2 class="item-title">
                                    <a href="/html/shop.html">Bracelets</a>
                                  </h2>
                                </div>
                              </div>
                            </div>
                            <div class="item item-product-cat slick-slide">
                              <div class="item-product-cat-content">
                                <a href="/html/shop.html">
                                  <div class="item-image animation-horizontal">
                                    <img
                                      width="258"
                                      height="258"
                                      src="<?php echo base_url('');?>include/web/media/product/cat-2.jpg"
                                      alt="Charms"
                                    />
                                  </div>
                                </a>
                                <div class="product-cat-content-info">
                                  <h2 class="item-title">
                                    <a href="/html/shop.html">Charms</a>
                                  </h2>
                                </div>
                              </div>
                            </div>
                            <div class="item item-product-cat slick-slide">
                              <div class="item-product-cat-content">
                                <a href="/html/shop.html">
                                  <div class="item-image animation-horizontal">
                                    <img
                                      width="258"
                                      height="258"
                                      src="<?php echo base_url('');?>include/web/media/product/cat-3.jpg"
                                      alt="Earrings"
                                    />
                                  </div>
                                </a>
                                <div class="product-cat-content-info">
                                  <h2 class="item-title">
                                    <a href="/html/shop.html">Earrings</a>
                                  </h2>
                                </div>
                              </div>
                            </div>
                            <div class="item item-product-cat slick-slide">
                              <div class="item-product-cat-content">
                                <a href="/html/shop.html">
                                  <div class="item-image animation-horizontal">
                                    <img
                                      width="258"
                                      height="258"
                                      src="<?php echo base_url('');?>include/web/media/product/cat-4.jpg"
                                      alt="Necklaces"
                                    />
                                  </div>
                                </a>
                                <div class="product-cat-content-info">
                                  <h2 class="item-title">
                                    <a href="/html/shop.html">Necklaces</a>
                                  </h2>
                                </div>
                              </div>
                            </div>
                                ...
                                <a href="/html/shop.html">
                                  <div class="item-image animation-horizontal">
                                    <img
                                      width="258"
                                      height="258"
                                      src="<?php echo base_url('');?>include/web/media/product/cat-5.jpg"
                                      alt="Rings"
                                    />
                                  </div>
                                </a>
                      ...
                      <div class="intro-wrap">
                        ...
                        <div class="intro-item">
                          ...
                          <div class="content">
                            ...
                            <div class="text">
                              ...
                              tincidunt et, tinciduntamet est.In hac habitasse
                        ...
                        <div class="intro-btn">
                          <a
                            ...
                            class="button button-black button-arrow animation-horizontal"
                            >LEARN MORE</a
                          >
                        </div>
                      </div>
                    ...
                    <div class="section-column right">
                      <a href="/html/#">
                        <img
                          ...
                          width="820"
                          height="674"
                          src="<?php echo base_url('');?>include/web/media/banner/intro-1.jpg"
                          alt="intro"
                        />
                      </a>
                    </div>
                                    ...
                                    <div class="product-thumb-hover">
                                      <a href="/html/shop-details.html">
                                        <img
                                          width="600"
                                          height="600"
                                          src="<?php echo base_url('');?>include/web/media/product/1.jpg"
                                          class="post-image"
                                          alt=""
                                        />
                                        <img
                                          width="600"
                                          height="600"
                                          src="<?php echo base_url('');?>include/web/media/product/1-2.jpg"
                                    ...
                                    <div class="product-thumb-hover">
                                      <a href="/html/shop-details.html">
                                        <img
                                          width="600"
                                          height="600"
                                          src="<?php echo base_url('');?>include/web/media/product/2.jpg"
                                          class="post-image"
                                          alt=""
                                        />
                                        <img
                                          width="600"
                                          height="600"
                                          src="<?php echo base_url('');?>include/web/media/product/2-2.jpg"
                                          class="hover-image back"
                                          alt=""
                                        />
                                      </a>
                                    ...
                                    <div class="product-thumb-hover">
                                      <a href="/html/shop-details.html">
                                        <img
                                          width="600"
                                          height="600"
                                          src="<?php echo base_url('');?>include/web/media/product/3.jpg"
                                          class="post-image"
                                          alt=""
                                        />
                                        <img
                                          width="600"
                                          height="600"
                                          src="<?php echo base_url('');?>include/web/media/product/3-2.jpg"
                                          class="hover-image back"
                                          alt=""
                                        />
                                      </a>
                                    ...
                                    <div class="product-thumb-hover">
                                      <a href="/html/shop-details.html">
                                        <img
                                          width="600"
                                          height="600"
                                          src="<?php echo base_url('');?>include/web/media/product/4.jpg"
                                          class="post-image"
                                          alt=""
                                        />
                                        <img
                                          width="600"
                                          height="600"
                                          src="<?php echo base_url('');?>include/web/media/product/4-2.jpg"
                                          class="hover-image back"
                                          alt=""
                                        />
                                      </a>
                                    ...
                                    <div class="product-thumb-hover">
                                      <a href="/html/shop-details.html">
                                        <img
                                          width="600"
                                          height="600"
                                          src="<?php echo base_url('');?>include/web/media/product/13.jpg"
                                          class="post-image"
                                          alt=""
                                        />
                                        <img
                                          width="600"
                                          height="600"
                                          src="<?php echo base_url('');?>include/web/media/product/13-2.jpg"
                                          class="hover-image back"
                                          alt=""
                                        />
                                      </a>
                                ...
                                <div class="banner-image">
                                  <a href="/html/shop.html">
                                    <img
                                      width="856"
                                      height="496"
                                      src="<?php echo base_url('');?>include/web/media/banner/banner-1-4.jpg"
                                      alt="Banner Image"
                                    />
                                  </a>
                                </div>
                                ...
                                <div class="banner-image">
                                  <a href="/html/shop.html">
                                    <img
                                      width="856"
                                      height="496"
                                      src="<?php echo base_url('');?>include/web/media/banner/banner-1-5.jpg"
                                      alt="Banner Image"
                                    />
                                  </a>
                                </div>
                              ...
                              <div class="item">
                                <div class="testimonial-item">
                                  ...
                                  <div class="testimonial-excerpt">
                                    Quality and product is premium and fit is
                                    awesome.
                                  </div>
                                </div>
                                <div
                                  class="testimonial-image image-position-top"
                                >
                                  <div class="thumbnail">
                                    <img
                                      width="110"
                                      height="110"
                                      src="<?php echo base_url('');?>include/web/media/testimonial/1.jpg"
                                      alt=""
                                    />
                                  </div>
                                ...
                                >
                                  <div class="thumbnail">
                                    <img
                                      width="110"
                                      height="110"
                                      src="<?php echo base_url('');?>include/web/media/testimonial/2.jpg"
                                      alt=""
                                    />
                                  </div>
                                  <div class="testimonial-info">
                            ...
                            <div class="testimonial-content">
                              <div class="item">
                                <div class="testimonial-item">
                                  ...
                                  <h2 class="testimonial-title">“Wow!”</h2>
                                  <div class="testimonial-excerpt">
                                    Just love it...
                                  </div>
                                </div>
                                ...
                                >
                                  <div class="thumbnail">
                                    <img
                                      width="110"
                                      height="110"
                                      src="<?php echo base_url('');?>include/web/media/testimonial/3.jpg"
                                      alt=""
                                    />
                                  </div>
                                  <div class="testimonial-info">
                                ...
                                >
                                  <div class="thumbnail">
                                    <img
                                      width="110"
                                      height="110"
                                      src="<?php echo base_url('');?>include/web/media/testimonial/4.jpg"
                                      alt=""
                                    />
                                  </div>
                                  <div class="testimonial-info">
              ...
              <section
                class="section section-padding top-border p-t-10 p-b-10 m-b-0"
              >
                <div class="section-container">
                  <!-- Block Image -->
                            ...
                            <div class="item-image animation-horizontal">
                              <a href="/html/#">
                                <img
                                  width="450"
                                  height="450"
                                  src="<?php echo base_url('');?>include/web/media/brand/1.jpg"
                                  alt="Brand 1"
                                />
                              </a>
                            </div>
                            ...
                            <div class="item-image animation-horizontal">
                              <a href="/html/#">
                                <img
                                  width="450"
                                  height="450"
                                  src="<?php echo base_url('');?>include/web/media/brand/2.jpg"
                                  alt="Brand 2"
                                />
                              </a>
                            </div>
                            ...
                            <div class="item-image animation-horizontal">
                              <a href="/html/#">
                                <img
                                  width="450"
                                  height="450"
                                  src="<?php echo base_url('');?>include/web/media/brand/3.jpg"
                                  alt="Brand 3"
                                />
                              </a>
                            </div>
                            ...
                            <div class="item-image animation-horizontal">
                              <a href="/html/#">
                                <img
                                  width="450"
                                  height="450"
                                  src="<?php echo base_url('');?>include/web/media/brand/4.jpg"
                                  alt="Brand 4"
                                />
                              </a>
                            </div>
                            ...
                            <div class="item-image animation-horizontal">
                              <a href="/html/#">
                                <img
                                  width="450"
                                  height="450"
                                  src="<?php echo base_url('');?>include/web/media/brand/5.jpg"
                                  alt="Brand 5"
                                />
                              </a>
                            </div>
                      ...
                      <div class="block-content">
                        <ul>
                          <li>
                            ...
                            <a
                              href="https://maps.app.goo.gl/rQSLBWx4SLCjnyfZ9"
                              target="_blank"
                            >
                          ...
                          <li>
                            <span>Email:</span>
                            <a href="mailto:support@shinearium.com;"
                              >support@shinearium.com</a
                            >
                          </li>
                        </ul>
                      </div>
                    ...
                    <div class="block block-menu">
                      ...
                      <div class="block-content">
                        <ul>
                          ...
                          <li>
                            <a href="/html/shop.html">Pendant</a>
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="footer-right">
                      <div class="block block-image">
                        <img
                          width="309"
                          height="32"
                          src="<?php echo base_url('');?>include/web/media/payments.png"
                          alt=""
                        />
                      </div>
                    </div>
    ...
    <div class="search-overlay">
      ...
      <div class="wrapper-search">
        <form
          ...
          action="#"
        >
          <a href="/html/#" class="search-close"></a>
          <div class="search-box">
            ...
            <div class="content-menu_search">
              ...
              <ul id="menu_search" class="menu">
                <li><a href="/html/#">Earrings</a></li>
                <li><a href="/html/#">Necklaces</a></li>
                <li><a href="/html/#">Bracelets</a></li>
                <li><a href="/html/#">Jewelry Box</a></li>
              </ul>
            </div>
          </div>
        </form>
            ...
            <div class="compare-table-items">
              <table id="product-table" class="product-table">
                <thead>
                  <tr>
                    <th>
                      <a href="/html/#" class="compare-table-settings"
                        >Settings</a
                      >
                    </th>
                    <th>
                ...
                <tbody>
                  ...
                  <tr class="tr-add-to-cart">
                    ...
                    <td>
                      <div data-title="Add to cart">
                        <a href="/html/#" class="button">Add to cart</a>
                      </div>
                    </td>
                    <td>
                      <div data-title="Add to cart">
    ...
    <div class="quickview-popup">
      <div id="quickview-container">
        <div class="quickview-container">
          <a href="/html/#" class="quickview-close"></a>
                          ...
                          <div class="slick-wrap">
                            ...
                            >
                              <div class="img-thumbnail slick-slide">
                                <a
                                  href="/html<?php echo base_url('');?>include/web/media/product/3.jpg"
                                  class="image-scroll"
                                  title=""
                                >
                                  <img
                              ...
                              <div class="img-thumbnail slick-slide">
                                <a
                                  href="/html<?php echo base_url('');?>include/web/media/product/3-2.jpg"
                                  class="image-scroll"
                                  title=""
                                >
                                  <img
