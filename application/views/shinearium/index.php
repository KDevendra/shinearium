                              ...
                              <div class="banner-wrapper-infor text-center">
                                <div class="info">
                                  <div class="content">
                                    ...
                                    <a class="button center" href="/html/shop.html">Shop Now</a>
                                  </div>
                                </div>
                              </div>
                            </div>
                ...
                <div class="row">
                  <div class="section-column left">
                    <div class="intro-wrap">
                      ...
                      <div class="intro-btn">
                        <a href="javascript:void(0)" class="button button-black button-arrow animation-horizontal">LEARN MORE</a>
                      </div>
                    </div>
                  </div>
                  <div class="section-column right">
                              ...
                              <div class="banner-wrapper-infor">
                                <div class="info">
                                  <div class="content">
                                    ...
                                    <a class="button button-outline thick-border border-white button-arrow" href="/html/shop.html">Explore</a>
                                  </div>
                                </div>
                              </div>
                            </div>
                  ...
                  <div class="block block-menu">
                    ...
                    <div class="block-content">
                      <ul>
                        ...
                        <li>
                          <a href="https://www.shiprocket.in/shipment-tracking/" target="_blank">Track Your Order</a>
                        </li>
                        <li>
                          <a href="https://www.shiprocket.in/shipment-tracking/" target="_blank">Shipping & Returns</a>
                        </li>
                      </ul>
                    </div>
                  </div>
    ...
    <div class="compare-popup-inner">
      <div class="compare-table">
        <div class="compare-table-inner">
          <a href="/html/#" id="compare-table-close" class="compare-table-close">
