<div class="content-header">
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6">
            <h1 class="m-0">Edit Sub [Sub-]Category</h1>
         </div>
         <div class="col-sm-6">
      ...
      <div class="row">
         <div class="col-12">
            <div class="card card-info">
               ...
               <?php } ?>
               <form id="formAddProduct" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>admin/category/save/edit">
                  <input type="hidden" name="category_id" id="category_id" value="<?php echo $c_data->category_id; ?>" />
                  <div class="card-body">
                     <div class="row">
                        <div class="col-md-4">
                           <div class="form-group">
                              ...
                              <select class="form-control select2" style="width: 100%;" id="category" name="category">
                                 ...
                                 foreach ($parent_category as $row) {
                                    $selected = '';
                                    if ($row['category_id'] == $c_data->parent_category_id) {
                                       $selected = 'selected';
                                    }
                        ...
                        <div class="col-md-4">
                           <div class="form-group">
                              ...
                              <input type="number" class="form-control" placeholder="Enter Display In Order " value="<?php echo $c_data->display_in_order; ?>" name="display_in_order">
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="title" name="title" placeholder="Enter title" maxlength="150" value="<?php echo $c_data->title; ?>">
                           </div>
                        </div>
                     </div>
                  </div>
