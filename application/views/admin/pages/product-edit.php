        ...
        <div class="row">
          	<div class="col-12">
				<div class="card card-info">
					...
					<?php } ?>				
					<form id="formAddProduct" enctype="multipart/form-data" method="post" action="<?php echo base_url(); ?>admin/product/save/edit">
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-md-12 mb-3 form-group img-parent-div">
										...
										if(count($product->images) > 0){
											foreach($product->images as $img){
												echo '<div class="img-wrap img_prod_'.$count.'">
													...
													<img src="'.$img['file_path'].'" width="110" height="110" class="rounded ml-3 shadow" data-image="'.$img['file_name'].'" data-id="'.$count.'" name="uploaded_image[]" value="'.$img['file_name'].'" data-new="no" data-prod_id="'.$product->product_id.'">
