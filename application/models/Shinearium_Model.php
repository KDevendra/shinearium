...
class Shinearium_Model extends CI_model
{
...
public  function dbDeleteMedia($tbl, $cond=NULL)
 ...
 public function dbProjectlockingId($id)
  ...
  public function getCategoriesWithConditionAndOrder()
  {
  ...
  function getAdminByEmail($tbl, $email)
  {
    return $this->db->where(['email' => $email])->get($tbl)->row();
  }
