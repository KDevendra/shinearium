$(function () {
	...
	if (image_url) {
	   if (is_new == 'clone') {
	      $('.img_prod_' + id).remove();
	      parent_div.append('<div class="col-md-12 mb-3 product-thumbs alert alert-success alert-dismissible fade show image_msg_success" role="alert">Image removed <button type="button" class="close" data-dismiss="alert" aria-label="Close">	<span aria-hidden="true">×</span> </button></div>');
	   } else {
	      $.ajax({
	         // headers: {
