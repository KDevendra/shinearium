$(function () {
	...
	var prod_id = $(this).closest('.img-wrap').find('img').data('prod_id');
	   ...
	   $.ajax({
	      ...
	      success: function (result) {
	         ...
	         if (result.status == true) {
	            $('.img_prod_' + id).remove();
	            parent_div.append('<div class="col-md-12 mb-3 product-thumbs alert alert-success alert-dismissible fade show image_msg_success" role="alert">' + result.message + ' <button type="button" class="close" data-dismiss="alert" aria-label="Close">	<span aria-hidden="true">×</span> </button></div>');
	         } else {
	            parent_div.append('<div class="col-md-12 mb-3 product-thumbs alert alert-danger alert-dismissible fade show image_msg_error" role="alert">' + result.message + ' <button type="button" class="close" data-dismiss="alert" aria-label="Close">	<span aria-hidden="true">×</span> </button></div>');
	         }
	         setTimeout(function () {
	...
	if (image.length > 0) {
	   if (image[0].size > 2000000) {
	      parent_div.append('<div class="col-md-12 mb-3 alert alert-danger alert-dismissible fade show image_u_msg_error" role="alert">Please upload file less than 2MB. Thanks!! <button type="button" class="close" data-dismiss="alert" aria-label="Close">	<span aria-hidden="true">×</span> </button></div>');
	      setTimeout(function () {
	...
	if (file.length > 0) {
	   if (file[0].size > 2000000) {
	      parent_div.append('<div class="col-md-12 mb-3 alert alert-danger alert-dismissible fade show ' + file_for + '_u_msg_error" role="alert">Please upload file less than 2MB. Thanks!! <button type="button" class="close" data-dismiss="alert" aria-label="Close">	<span aria-hidden="true">×</span> </button></div>');
	      setTimeout(function () {
	   ...
	   $.ajax({
	      ...
	      success: function (result) {
	         if (result.status == true) {
	            parent_div.append('<div class="col-md-12 mb-3 alert alert-success alert-dismissible fade show ' + file_for + '_u_msg_success" role="alert">' + result.message + ' <button type="button" class="close" data-dismiss="alert" aria-label="Close">	<span aria-hidden="true">×</span> </button></div>');
	            ...
	            parent_div.append('<div class="col-md-12 mb-3 alert alert-danger alert-dismissible fade show ' + file_for + '_u_msg_error" role="alert">' + result.message + ' <button type="button" class="close" data-dismiss="alert" aria-label="Close">	<span aria-hidden="true">×</span> </button></div>');
	...
	if (file) {
	   ...
	   formData.append('existing_file', existing_file);
	   formData.append('file_for', file_for);
	   formData.append('is_new_uploaded', 'no');
	...
	$.ajax({
	   ...
	   success: function (result) {
	      ...
	      if (result.length > 0) {
           ...
           // 				$('.img-parent-div').find('.image_u_msg_error').remove();
           // 				$('.img-parent-div').find('.image_u_msg_success').remove();
           // 				var formData = new FormData();
           // 				formData.append('product_id', product_id);
           ...
           // 						}						
           // 						if(result.status == true){
           // 							$('.img-parent-div').append('<div class="col-md-12 mb-3 alert alert-success alert-dismissible fade show image_u_msg_success" role="alert">'+result.message+' <button type="button" class="close" data-dismiss="alert" aria-label="Close">	<span aria-hidden="true">×</span> </button></div>');
           // 							$('.product-thumbs').append('<div class="img-wrap img_prod_'+count+'"><span class="close">×</span><img src="'+result.file_path+'" width="110" height="110" class="rounded ml-3 shadow" data-image="'+result.file_name+'" data-id="'+count+'" name="uploaded_image[]" value="'+result.file_name+'" data-new="yes"><input type="hidden" name="uploaded_image[]" value="'+result.file_name+'"/></div>');
           // 							count++;
           // 							$('.no-img-span').remove();
           // 						}else{
           // 							$('.img-parent-div').append('<div class="col-md-12 mb-3 alert alert-danger alert-dismissible fade show image_u_msg_error" role="alert">'+result.message+' <button type="button" class="close" data-dismiss="alert" aria-label="Close">	<span aria-hidden="true">×</span> </button></div>');
           // 						}
           // 						setTimeout(function(){
           // 							$alert.hide();
           // 							$(".image_u_msg_success").remove();
